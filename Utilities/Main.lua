...
function Utility.SettingsSection(Self, Window, UIKeybind, CustomMouse)
    ...
    local OptionsTab = Window:Tab({Name = "Options"}) do
        ...
        OptionsTab:AddConfigSection("Radical", "Left")
        ...
        local DiscordSection = OptionsTab:Section({Name = "Discord", Side = "Right"}) do
            DiscordSection:Label({Text = "Invite Code: NULL"})
            DiscordSection:Button({Name = "Copy Invite Link", Callback = function() setclipboard("https://discord.gg/NULL") end})
        ...
        local CreditsSection = OptionsTab:Section({Name = "Credits", Side = "Right"}) do
            CreditsSection:Label({Text = "Sustained by kazuw @ discord.com"})
            CreditsSection:Label({Text = "Origially made by: AlexR32"})
