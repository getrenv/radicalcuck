...
local Window = Radical.Utilities.UI:Window({
    ...
    local VisualsSection = Radical.Utilities:ESPSection(Window, "Visuals", "ESP/NPC", true, true, true, true, true, true) do
    ...
    end Radical.Utilities:SettingsSection(Window, "End", false)
...
for Index, Item in pairs(Items:GetChildren()) do
    Radical.Utilities.Drawing:AddObject(Item, Item.Name, Item.PrimaryPart.Position,
