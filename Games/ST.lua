...
local Window = Radical.Utilities.UI:Window({
    ...
    local VisualsSection = Radical.Utilities:ESPSection(Window, "Visuals", "ESP/Player", true, true, false, false, true, false) do
...
local function PlayerFly(Enabled, Speed, EnableCamera)
    ...
    if LPTank and LPTank.PrimaryPart then
        LPTank.PrimaryPart.AssemblyLinearVelocity = Radical.Utilities.MovementToDirection() * Speed
